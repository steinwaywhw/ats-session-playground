...
zmq: zmqclient.dats zmqserver.dats
	patscc -D_GNU_SOURCE -DATS_MEMALLOC_LIBC -o client zmqclient.dats -lpthread -L/usr/local/lib -lzmq
	patscc -D_GNU_SOURCE -DATS_MEMALLOC_LIBC -o server zmqserver.dats -lpthread -L/usr/local/lib -lzmq
